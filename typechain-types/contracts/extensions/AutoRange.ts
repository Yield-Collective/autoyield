...
export declare namespace AutoRange {
...
export interface AutoRangeInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, AutoRange.RangePositionConfigStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "execute",
    values: [AutoRange.RangeExecuteParamsStruct]
  ): string;
...
export interface AutoRange extends BaseContract {
  connect(runner?: ContractRunner | null): AutoRange;
  waitForDeployment(): Promise<this>;

  interface: AutoRangeInterface;
  ...
  configToken: TypedContractMethod<
    [tokenId: BigNumberish, config: AutoRange.RangePositionConfigStruct],
    [void],
    "nonpayable"
  >;

  execute: TypedContractMethod<
    [params: AutoRange.RangeExecuteParamsStruct],
    [void],
    "nonpayable"
  >;
