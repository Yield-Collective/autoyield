...
export declare namespace AutoExit {
  export type ExitPositionConfigStruct = {
    isActive: boolean;
    token0Swap: boolean;
    token1Swap: boolean;
    token0TriggerTick: BigNumberish;
    token1TriggerTick: BigNumberish;
  ...
  export type ExitPositionConfigStructOutput = [
    isActive: boolean,
    token0Swap: boolean,
    token1Swap: boolean,
    token0TriggerTick: bigint,
    token1TriggerTick: bigint,
  ...
  export type ExitExecuteParamsStruct = {
  ...
  export type ExitExecuteParamsStructOutput = [
    tokenId: bigint,
    swapData: string,
    liquidity: bigint,
...
export interface AutoExitInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, AutoExit.ExitPositionConfigStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "execute",
    values: [AutoExit.ExitExecuteParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "exitPositionConfigs",
    values: [BigNumberish]
  ): string;
...
export namespace ExecutedEvent {
  export type InputTuple = [
    ...
    account: AddressLike,
    isSwap: boolean,
    amountReturned0: BigNumberish,
    amountReturned1: BigNumberish,
    token0: AddressLike,
    token1: AddressLike
  ];
...
export namespace ExitPositionConfiguredEvent {
  export type InputTuple = [
    tokenId: BigNumberish,
    isActive: boolean,
    token0Swap: boolean,
...
export interface AutoExit extends BaseContract {
  connect(runner?: ContractRunner | null): AutoExit;
  waitForDeployment(): Promise<this>;

  interface: AutoExitInterface;
  ...
  configToken: TypedContractMethod<
    [tokenId: BigNumberish, config: AutoExit.ExitPositionConfigStruct],
    [void],
    "nonpayable"
  >;

  execute: TypedContractMethod<
    [params: AutoExit.ExitExecuteParamsStruct],
    [void],
    "nonpayable"
  >;

  exitPositionConfigs: TypedContractMethod<
    [arg0: BigNumberish],
    [
      [
        boolean,
  ...
  >;
  getFunction(
    nameOrSignature: "exitPositionConfigs"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [
      [
  ...
  >;
  getEvent(
    key: "ExitPositionConfigured"
  ): TypedContractEvent<
    ExitPositionConfiguredEvent.InputTuple,
    ExitPositionConfiguredEvent.OutputTuple,
    ExitPositionConfiguredEvent.OutputObject
  >;
  getEvent(
    key: "OperatorChanged"
  ): TypedContractEvent<
  ...
  filters: {
    "Executed(uint256,address,bool,uint256,uint256,address,address)": TypedContractEvent<
      ExecutedEvent.InputTuple,
      ExecutedEvent.OutputTuple,
      ExecutedEvent.OutputObject
    >;
    ...
    "ExitPositionConfigured(uint256,bool,bool,bool,int24,int24,uint64,uint64,bool,uint64)": TypedContractEvent<
      ExitPositionConfiguredEvent.InputTuple,
      ExitPositionConfiguredEvent.OutputTuple,
      ExitPositionConfiguredEvent.OutputObject
    >;
    ExitPositionConfigured: TypedContractEvent<
      ExitPositionConfiguredEvent.InputTuple,
      ExitPositionConfiguredEvent.OutputTuple,
      ExitPositionConfiguredEvent.OutputObject
    >;
